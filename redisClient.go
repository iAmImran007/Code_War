...
//get all problem 
func (r *Redis) GetAllProblems() ([]ProblemPropaty, error) {
...
func (r *Redis) GetRandomproblem() (*ProblemPropaty, error) {
...
//getByid
func (r *Redis) GetProblemById(problemId uint) (*ProblemPropaty, error) {
